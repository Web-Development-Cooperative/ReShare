...
export type AuthChangePasswordUpdateData = any;
 ...
 * @version v1
 *
 * Identity and Authentication service for ResX platform
 */
export class Api<
...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    authRegisterCreate: (
      ...
      this.request<AuthRegisterCreateData, ProblemDetails>({
     ...
     */
    authLoginCreate: (data: LoginUserCommand, params: RequestParams = {}) =>
      this.request<AuthLoginCreateData, ProblemDetails>({
        path: `/api/auth/login`,
        method: "POST",
        body: data,
        type: ContentType.Json,
    ...
    authChangePasswordUpdate: (
      ...
      this.request<AuthChangePasswordUpdateData, ProblemDetails>({
