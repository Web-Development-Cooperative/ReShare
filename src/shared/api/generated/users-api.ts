...
export type UsersDetailData = any;

export type UsersMeListData = any;
...
export type UsersReviewsListData = any;
...
export type UsersReviewsCreateData = any;
...
export type UsersLeaderboardListData = any;
...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    usersMeUpdate: (data: UpdateProfileRequest, params: RequestParams = {}) =>
      this.request<UsersMeUpdateData, any>({
        path: `/api/users/me`,
        method: "PUT",
        body: data,
        secure: true,
    ...
    usersMeAvatarUpdate: (
      ...
      this.request<UsersMeAvatarUpdateData, any>({
    ...
    usersReviewsList: (
      ...
      this.request<UsersReviewsListData, any>({
    ...
    usersReviewsCreate: (
      ...
      this.request<UsersReviewsCreateData, any>({
        path: `/api/users/${id}/reviews`,
        method: "POST",
        body: data,
        secure: true,
